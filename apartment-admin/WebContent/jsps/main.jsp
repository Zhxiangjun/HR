              ...
              <div class="container">
                <div class="navbar-header">
                    <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar" >
                      ...
                      <a class="navbar-brand" href="main.jsp">www.apartment_for_rent.com</a>
                </div>
                
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">                        
                        <li><a href="javascript:void(0);" onclick="showAtRight('memberList.jsp')"><i class="fa fa-users"></i> 用户列表</a></li>    
                        <li><a href="javascript:void(0);" onclick="showAtRight('apartmentList.jsp')"><i class="fa fa-home"></i> 房源审核</a></li>
                        <li><a href="javascript:void(0);" onclick="showAtRight('0.jsp')" ><i class="fa fa-bed"></i> 入住列表</a></li> 
                        <li><a href="javascript:void(0);" onclick="showAtRight('echarts.jsp')" ><i class="fa fa-list"></i> 数据统计</a></li> <li><p>&nbsp;&nbsp;&nbsp;&nbsp;</p></li>
            ...
            <div class="row-fluie">
                <div class="col-sm-3 col-md-2 sidebar">        
                    <ul class="nav nav-sidebar">
                        <!-- 一级菜单 -->
                        <li class="active"><a href="#memberMeun" class="nav-header menu-first collapsed" data-toggle="collapse">
                            <i class="fa fa-user"></i>&nbsp; 用户管理 <span class="sr-only">(current)</span></a>
                        </li> 
                        <!-- 二级菜单 -->
                        <!-- 注意一级菜单中<a>标签内的href="#……"里面的内容要与二级菜单中<ul>标签内的id="……"里面的内容一致 -->
                        <ul id="memberMeun" class="nav nav-list collapse menu-second">
                            <li><a href="javascript:void(0);" onclick="showAtRight('memberList.jsp')"><i class="fa fa-users"></i> 用户列表管理</a></li>
                        </ul>
                         
                        <li><a href="#apartmentMeun" class="nav-header menu-first collapsed" data-toggle="collapse">
                            <i class="fa fa-globe"></i>&nbsp; 房源管理 <span class="sr-only">(current)</span></a>
                        </li> 
                        <ul id="apartmentMeun" class="nav nav-list collapse menu-second">
                     	   <li><a href="javascript:void(0);" onclick="showAtRight('apartmentList.jsp')"><i class="fa fa-search-plus"></i> 公寓信息管理</a></li>
                        	<li><a href="javascript:void(0);" onclick="showAtRight('furnitureList.jsp')"><i class="fa fa-plus"></i> 房源配置管理</a></li>
                            <li><a href="javascript:void(0);" onclick="showAtRight('roomList.jsp')"><i class="fa fa-home"></i> 房源信息审核</a></li>
                             <li><a href="javascript:void(0);" onclick="showAtRight('priceList.jsp')"><i class="fa fa-rmb"></i> 房源价格查询</a></li>
                             <li><a href="javascript:void(0);" onclick="showAtRight('uploadList.jsp')"><i class="fa fa-refresh"></i> 审核上架管理</a></li>
                        </ul>
                        
                        <li><a href="#recordMeun" class="nav-header menu-first collapsed" data-toggle="collapse">
                            <i class="fa fa-file-text"></i>&nbsp; 入住管理 <span class="sr-only">(current)</span></a>
                        </li> 
                        <ul id="recordMeun" class="nav nav-list collapse menu-second">
                            <li><a href="javascript:void(0);" onclick="showAtRight('intakeList.jsp')" ><i class="fa fa-bed"></i> 入住列表查询</a></li>
                            <li><a href="javascript:void(0);" onclick="showAtRight('intakeInfo.jsp')" ><i class="fa fa-pencil"></i> 入住信息登记</a></li>
                            <li><a href="javascript:void(0);" onclick="showAtRight('pactList.jsp')" ><i class="fa fa-folder"></i> 合同信息管理</a></li>
                            <li><a href="javascript:void(0);" onclick="showAtRight('payList.jsp')"><i class="fa fa-money"></i> 缴费信息管理</a></li>
                        </ul>
                        
                         <li><a href="#adminMeun" class="nav-header menu-first collapsed" data-toggle="collapse">
                            <i class="fa fa-gears"></i>&nbsp; 后台管理 <span class="sr-only">(current)</span></a>
                        </li>
                        <ul id="adminMeun" class="nav nav-list collapse menu-second">
                            <li><a href="javascript:void(0);" onclick="showAtRight('echarts.jsp')"><i class="fa fa-bar-chart"></i> 信息数据统计</a></li>
                            <li><a href="javascript:void(0);" onclick="showAtRight('authority.jsp')" ><i class="fa fa-sitemap"></i> 权限发放设置</a></li>
                        </ul>
                    </ul>
                </div>
            </div>
